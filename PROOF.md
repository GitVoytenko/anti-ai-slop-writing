...
**7 findings across 5 files, 3042 words** — 0 high, 0 medium, 7 low.

| File | Language | Words | High | Medium | Low |
| --- | --- | --- | --- | --- | --- |
| `CONTRIBUTING.md` | en | 528 | 0 | 0 | 0 |
| `README.md` | en | 891 | 0 | 0 | 3 |
...
- `README.md:174:12` **low** rule-of-three — group of three — use two, four, or one unless the content really has three items
