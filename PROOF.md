...
- `docs/detector.md:97:25` **low** rule-of-three — group of three — use two, four, or one unless the content really has three items
- `docs/detector.md:98:1` **low** rule-of-three — group of three — use two, four, or one unless the content really has three items
